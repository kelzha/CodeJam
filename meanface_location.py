    ...
    for k in xrange(1,kmax):
        ...
        for i in xrange(0,dxRight,dxRight/xSteps):
            for j in xrange(0,dxBot,dxBot/ySteps):
                ...
                arr = np.asarray(testIm_cs)

                max_idx, max_match = fish.recognize(arr.flatten())
                # print best_idx
                # print max_match
...
fish = FishRecon('bin/phase2_fish_doug_lastminute/')
for pic_path in dataset:
    print kkk
    # print 'pic#', kkk
#pic_path='C:/Users/Doug/Desktop/McGill Fall 2014/CODEJAM/barack_obama_56.jpg'
    locate_face(pic_path)

#    crop.cropp(pic_path, centerX, centerY, Wi, He)IMG_20141121_042505.bmp